...
*/
function isOperatorValid(operando){
return !!operation[operando];
}
/*
...
*/
function showErrorMessage(operador,x,y){
...
console.log(showErrorMessage(operationSignal,number1,number2));
}
else {
