...
*/
console.log('A soma de 2 e 10 é igual a ' + sum()(2,10) + '.');
...
no console.
*/
console.log(subtraction(654,65));
console.log(multiplication(223,56));
console.log(division(335,10));
console.log(mod(23424,10));