...
*/
var carro = {marca : String , modelo: String , placa : String , ano : Number , cor : String , qunatasPortas: Number , assentos : 5 , quantidadePessoas: 0 };
...
carro.addPessoas = function(nPessoas){
        var soma = carro.quantidadePessoas + nPessoas;
        var limPessoas = soma- carro.assentos;
        var pessoasFaltam =   carro.assentos - carro.quantidadePessoas;
        // limpessoas = 3 + 30 - 5= 5
        var pessoasFrase = pessoasFaltam === 1 ? ` pessoa!` : ` pessoas!`;
        ...
        if(soma <= carro.assentos){
        carro.quantidadePessoas += nPessoas;
        }
                var retornar = soma > carro.assentos ? `Só cabem mais `+ pessoasFaltam + pessoasFrase :`Já temos `+ carro.quantidadePessoas  +` pessoas no carro!`;
        return retornar;
...
carro.obterMarcaModelo(); //"Esse carro é um function String() { [native code] } function String() { [native code] 
